...
export default function SanctuaryPage() {
  ...
  const EMAILJS_SERVICE_ID =
    process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID || "service_4v6c312";
  const EMAILJS_TEMPLATE_ID =
    process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || "template_9hw8287";
  const EMAILJS_PUBLIC_KEY =
    process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY || "084x3_9KyEngMn8Nm";
  ...
  const steps = [
    {
      ...
      question:
        "What part of your current leadership journey feels misaligned or unclear?",
      description:
        "Please describe without framing it as a professional problem only.",
      type: "textarea",
      key: "selfReflection",
    },
    {
      ...
      question:
        "Are you open to receiving difficult truths without defending them?",
      type: "radio",
    ...
    },
    {
      ...
      description:
        "Legacy is not about wealth or power. What is your soul asking to preserve or redeem?",
      type: "textarea",
      key: "legacyIntention",
    },
    {
      ...
      question:
        "Can you commit to keeping all VSOLVE engagements private, unrecorded, and sacred?",
      type: "radio",
      key: "confidentiality",
      options: [
        { value: "yes", label: "Yes" },
    ...
    },
    {
      ...
      question:
        "Who referred you to VSOLVE? Why do you think they believed you were ready for this process?",
      description:
        "If self-initiated, please explain how you discovered us and what moved you to write.",
      type: "textarea",
      key: "referralOrigin",
    },
    {
      ...
      question:
        "Why now? What has shifted in your life that calls you to clarity at this moment?",
      description:
        "We do not rush timing. But we honor when the moment becomes true.",
      type: "textarea",
      key: "timing",
    },
    {
      ...
      question:
        "Are you prepared to engage with premium, bespoke pricing that honors depth, privacy, and founder energy?",
      type: "radio",
    ...
    },
    {
      ...
      question:
        "Do you currently hold decision-making capacity in your institution, family, or legacy circle?",
      type: "radio",
      key: "authority",
      options: [
        { value: "yes", label: "Yes" },
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_email: "codexcouncil@vsolvegroup.com", // Update this with your actual receiving email
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-xl text-vsolve-ivory/85 leading-relaxed max-w-3xl mx-auto mb-6 font-medium">
                  This sacred system operates on invitation only. You have
                  demonstrated the readiness for strategic clarity that serves
                  beyond profit and ego. Welcome to the inner sanctuary of
                ...
                <div className="max-w-2xl mx-auto mb-8 p-6 bg-vsolve-gold/5 border border-vsolve-gold/20 rounded-lg">
                  <p className="text-vsolve-ivory/80 leading-relaxed font-medium mb-4">
                    The following reflection questions will be reviewed in
                    silence by our internal council to determine alignment and
                    readiness for the VSOLVE Clarity System.
                  </p>
                  ...
                  {submissionStatus === "success" ? (
                    <>
                      ...
                      <div>
                        <h4 className="font-semibold text-lg">
                          Sacred Reflection Submitted
                        </h4>
                        <p className="text-sm opacity-90">
                          Your responses have been sent to our council for
                          review. We will contact you within 7-10 days.
                        </p>
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-sm opacity-90">
                          There was an issue sending your reflection. Your
                          responses are saved locally. Please try again or
                          contact us directly.
                        </p>
                      </div>
                    </>
                    ...
                    <div className="max-w-2xl mx-auto">
                      {currentStepData.type === "textarea" && (
                        <textarea
                          value={
                            formData[
                              currentStepData.key as keyof typeof formData
                            ]
                          }
                          onChange={(e) =>
                            handleInputChange(
                ...
                >
                  ...
                  <div className="max-w-3xl mx-auto space-y-8 text-vsolve-ivory/80 leading-relaxed">
                    <p className="text-lg lg:text-xl font-medium">
                      Your answers will not be judged. They are only reviewed
                      for alignment, timing, and sacred readiness. If you are
                      not yet a fit, we will close the loop gently and
                      respectfully. If the path is open, we will invite you into
                      a clarity circle with Dr. George Varghese or an appointed
                      guide.
                    </p>
